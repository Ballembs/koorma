    ...
    <div className="flex flex-col items-center justify-center p-6 h-full w-full">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="bg-white p-10 rounded-3xl shadow-xl border-4 border-[#C8E6C9] w-full max-w-lg flex flex-col items-center mb-12"
        >
          <div className="text-9xl mb-6">{current.emoji}</div>

          <div className="text-6xl font-bold text-[#2E7D32] font-telugu mb-4">
            {current.te}
          </div>

          <div className="text-2xl text-gray-500 font-nunito font-bold border-t pt-4 w-full text-center">
            {current.en}
          </div>
          ...
          <div className="mt-8">
            <motion.button
              ...
              className="w-16 h-16 rounded-full bg-[#E8F5E9] shadow-md flex items-center justify-center text-3xl border-2 border-[#A5D6A7]"
            >
              🔊
            </motion.button>
          </div>
